...
exports.PaginatedIterator = exports.MAX_PAGE_SIZE = exports.DEFAULT_PAGINATION = void 0;
...
exports.createAutoPaginator = createAutoPaginator;
...
function validatePaginationParams(params = {}) {
    const validated = {
        limit: params.limit ?? exports.DEFAULT_PAGINATION.limit,
        offset: params.offset ?? exports.DEFAULT_PAGINATION.offset,
        cursor: params.cursor ?? exports.DEFAULT_PAGINATION.cursor,
    };
    // Validate limit
    if (validated.limit < 1) {
        validated.limit = exports.DEFAULT_PAGINATION.limit;
    }
    else if (validated.limit > exports.MAX_PAGE_SIZE) {
        validated.limit = exports.MAX_PAGE_SIZE;
    }
    // Validate offset
 ...
 */
function createPaginationQuery(params) {
    const validated = validatePaginationParams(params);
    const query = {};
    if (validated.limit !== exports.DEFAULT_PAGINATION.limit) {
 ...
 */
function calculatePaginationMeta(totalItems, params) {
 ...
 */
function createPaginatedResponse(data, params, totalItems, nextCursor) {
