...
exports.MockRotationProvider = exports.CredentialRotationManager = void 0;
const events_1 = require("events");
const credential_validator_1 = require("./credential-validator");
/**
 ...
 */
class CredentialRotationManager extends events_1.EventEmitter {
    constructor(config = {}) {
        super();
    ...
    registerCredentials(clientId, metadata = {}) {
        ...
        this.currentMetadata = {
            ...
            credentialId: credential_validator_1.CredentialValidator.maskCredential(clientId),
    ...
    async rotateCredentials() {
        ...
        try {
            ...
            this.currentMetadata = {
                ...this.currentMetadata,
                lastRotated: now,
                credentialId: credential_validator_1.CredentialValidator.maskCredential(newCredentials.clientId),
            };
...
exports.CredentialRotationManager = CredentialRotationManager;
/**
...
exports.MockRotationProvider = MockRotationProvider;
